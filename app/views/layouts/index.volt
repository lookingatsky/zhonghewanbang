	...
	{{ javascript_include('js/index/indes_effect.js') }}
	{{ javascript_include('js/index/topbanner.js') }}	
	{{ javascript_include('js/index/jwplayer.js') }}	
			...
			<section class="clearfix headerbg">
				<section class="header_warp">
					...
					<div class="menubox fr">
								...
								<div class="clearfix">
									...
									<div class="fr">
										...
										<div class="inputbox fl">
											<i class="web_skin search_icon"></i><input type="text" name="search" value="">
										</div>
						...
						<nav>
							<ul class="clearfix menu_list mt20"> <li class="w77"><a href="/index/index" class="menu_on">首&nbsp;&nbsp;页</a></li>
								<li class="menu_line">|</li>
								<li class="rel">
								<a href="/about/index">关于我们</a><!-- class="menu_on" -->
									<div class="menulist">
