	...
	{{ stylesheet_link('css/index/prettyPhoto.css') }}	
...
<!--	{{ javascript_include('js/index/indes_effect.js') }}
	...
	{{ javascript_include('js/index/chj.js') }}
	{{ javascript_include('js/index/jquery.js') }}
				...
				<div class="menubox fr">
					...
					<nav>
						<ul class="clearfix menu_list mt20"> <li class="w77"><a href="/index/index">首&nbsp;&nbsp;页</a></li>
							...
							<li class="rel">
								<a href="/index/index" class="menu_on">关于我们</a><!-- class="menu_on" -->
								<div class="menulist">
